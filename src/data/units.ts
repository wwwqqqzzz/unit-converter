...
export const CATEGORY_VALUES: Record<string, number[]> = {
  length: [1, 5, 10, 50, 100, 500, 1000, 5000],
  weight: [1, 5, 10, 50, 100, 500, 1000, 5000],
  temperature: [0, 20, 37, 100, 200, 500, 1000],
  data: [1, 10, 100, 1000, 1024, 1048576, 1073741824],
  area: [1, 10, 100, 1000, 10000, 100000],
  volume: [1, 5, 10, 50, 100, 500, 1000],
  speed: [1, 10, 50, 100, 200, 500],
  time: [1, 60, 3600, 86400, 604800, 31557600],
  pressure: [1, 10, 100, 500, 1000, 5000],
  energy: [1, 10, 100, 1000, 10000],
  power: [1, 10, 100, 1000, 10000],
  fuel: [1, 5, 10, 50],
  frequency: [1, 100, 1000, 1000000],
  angle: [1, 45, 90, 180, 360],
  force: [1, 10, 100, 1000, 10000],
  torque: [1, 10, 100, 1000, 10000],
  shoe: [],
};
